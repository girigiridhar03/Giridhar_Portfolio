    ...
    <Box w={"100%"} h={"100vh"} id="home">
      <Container w={["100%"]} h={"100%"} maxW={"1500px"} mx={"auto"}>
        <Flex
          ...
          gap={["1.5rem", "1.8rem", "1.8rem", "1.8rem", "2rem"]}
        >
          <VStack>
            <Box
              ref={imageContainer}
              w={["120px", "120px", "130px", "130px", "150px"]}
              h={["120px", "120px", "130px", "130px", "150px"]}
              borderRadius={"50%"}
              overflow={"hidden"}
          ...
          >
            <Box
              fontSize={["2.8rem", "3.2rem", "3.5rem"]}
              fontWeight={"500"}
              lineHeight={["2.7rem", "2.8rem", "3.8rem"]}
            >
            ...
            <Text
              fontWeight={"500"}
              fontSize={["1rem"]}
              lineHeight={["1.7rem", "1.9rem"]}
            >
              I’m a frontend developer dedicated to building intuitive and
              beautiful web interfaces. Explore my portfolio to see a range of
              projects where I bring creativity and technical expertise
              together, transforming ideas into seamless user experiences.
            </Text>
          </VStack>
          <HStack
